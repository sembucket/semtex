...
c
c------------------------------------------------------------------------
c  Wrapper around the RCM routines to start from a specified ROOT
c  node for the first pass.  
c
c  RDH -- 7 May 1995
c
      SUBROUTINE  RCMROOT ( NEQNS, XADJ, ADJNCY, PERM, MASK, XLS, ROOT )
C                                                                      
C***************************************************************       
C                                                                      
...
c     First Level Structure is Rooted at the given node

         call ROOTLS (ROOT, XADJ, ADJNCY, MASK, NLVL, XLS, PERM(NUM))
C        call FNROOT (ROOT, XADJ, ADJNCY, MASK, NLVL, XLS, PERM(NUM))
         call RCM    (ROOT, XADJ, ADJNCY, MASK, 
     >                PERM(NUM), CCSIZE, XLS )
         NUM = NUM + CCSIZE

c     Continue with the rest of the graph
