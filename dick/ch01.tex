...
\hyphenation{horse-pow-ered horse-power-ed}
\hyphenation{steamer stea-m-er}

\index{USA|see{America}}
\index{Canada|see{America}}
\index{maize|see{cereals}}
\index{corn|see{cereals}}
\index{wheat|see{cereals}}
\index{lucerne|see{fodder}}
\index{hay|see{fodder}}

\index{irrigation|see{technology}}
\index{flood|see{technology, flooding}}
\index{canal|see{technology, canal}}
\index{reservoir|see{technology, reservoir}}
\index{pump|see{technology, pump}}
\index{weir|see{technology, weir}}
\index{dam|see{technology, dam}}
\index{railways|see{technology, railways}}
\index{channel|see{technology, channel}}
\index{bore|see{technology, bore}}
\index{pipe|see{technology, pipe}}
