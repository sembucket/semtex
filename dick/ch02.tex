...
Jackson} the settlement there came to be known as Parramatta
\index{Paramatta} and its growth for a few years outstripped that
...
while at Windsor \index{Windsor} on the Hawkesbury the average is near
35\,inches. The annual rainfall is variable but its seasonal
...
during the drought by Harriet King \index{King, H.} in letters to her
husband, Phillip Parker King, \index{King, P.\,K.} during 1827 and
...
some return from the wheat crop.\fn{\citet{walsh1967}.}
...
Jamison owned the imposing Regentville \index{Regentville} mansion and
land on the Nepean near Penrith; \index{Penrith} he was a wealthy man
...
Regentville.  James Backhouse\index{Backhouse, J.}  visited the
...
irrigation undertaken by the owner.\fn{\textsl{Sydney Monitor}, 3
Jan.\ 1835;
...
tidal reaches. The swamp covered approximately 200\,acres of his farm
...
the farm were subject to a tidal range of three to four feet at the
highest spring tide.\fn{\citet{shaw1967}; \citet{mckay1962};
...
Park\index{Henley Park, WA} was on the Helena River,\index{river!Helena}
...
tidal influence on the river and accessible by boat from Fremantle
