...
\fancyhead[RE]{\sffamily \small Chapter \thechapter. The Earliest Irrigators}
...
contemporary usage in \index{Britain}Britain, its adoption certainly
...
the penal settlement at Sydney\index{Sydney, NSW} was more or less
forced by his objections to Botany Bay\index{Botany Bay, NSW} and the
...
Jackson, NSW} the settlement there came to be known as Parramatta
\index{Parramatta, NSW} and its growth for a few years outstripped that
...
occupation then by Aborigines\index{Aborigines} was a further initial
...
Macquarie's\index{Governor!Macquarie} order for road improvement was
achieved with completion in 1813 of the turnpike road from Sydney to
the river at Windsor.\fn{HRA Series\,I no.\,1, pp.\,470, 483;
\textit{Sydney Gazette}, 27 Nov.\ 1813, cited by
\cite[p.\,57]{bowd1982}.}

The Hawkesbury River generated many \index{flood}floods; there were
...
punishment. One was Lawrence May,\index{May, L.} who may have been the
...
1828 he held 96\,acres at Pitt Town.\fn{\cite[p.\,22]{johnson1991};
\cite[p.\,143]{bowd1982}.}
...
while at Windsor \index{Windsor, NSW} on the Hawkesbury the average is
...
seasons and in the event of \index{drought}drought there was generally
...
longest and most widespread yet known.\fn{J.\,B.~Henson, \textit{Eng.\
Assoc.\ NSW Proc}.\ vol.\,6, (1889); \textit{Comm.\ Bur.\ Meteorol.\
Bull}.\ vol.\,48, (1967).}
...
\begin{Quote}
	...
	those fearful \index{drought}droughts to which we have reason
	...
	to distant tracts for \index{pasture}pasture and water,
	neither remaining in the located districts.  The interior
	suffered equally with the coast.\fn{\cite{sturt1833}.}
\end{Quote}

Conditions at Dunheved,\index{Dunheved, NSW} about 12 miles south of
Pitt Town\index{Pitt Town, NSW} on the Hawkesbury, were described in
some detail during the \index{drought}drought by Harriet King
\index{King, H.} in letters to her husband, Phillip Parker King,
\index{King, P.\,K.}  during 1827 and 1828. There was no complete lack
...
\index{wheat}wheat crop.\fn{\cite{walsh1967}.}

It was during this serious \index{drought}drought that Lawrence May
...
\begin{Quote}
	...
	the courage to erect a \index{technology!pump}pump for the
	...
	through lead \index{technology!pipe!lead}pipes into a ditch,
...
\index{drought}drought-stricken crop is uncertain: it appears that
...
pioneer \index{wool}wool-grower, invented a scheme for mechanical
...
\index{drought}drought of 1826--29 probably impelled Macarthur to
devise some means of watering plants of some value to him.  These were
in the \index{gardening}gardens, \index{fruit}orchards and
\index{vineyards}vineyards at his
residence.\fn{\cite[p.\,492]{ellis1978}.}
...
the Nepean River, \index{river!Nepean} which is continuous with the
Hawkesbury, but it is uncertain whether his plans came to fruition.
Jamison owned the imposing Regentville \index{Regentville mansion}
mansion and land on the Nepean near Penrith; \index{Penrith, NSW} he
...
mention of irrigation undertaken by the owner.\fn{\textit{Sydney
Monitor}, 3 Jan.\ 1835;
\cite[p.\,338]{backhouse1843}.}

\section*{Tasmania}\index{Tasmania}
\label{sec:tas}

In 1830 there was reference in the \textit{Hobart Town Almanack} to
irrigation of a property near Hobart.\index{Hobart, Tas.} This may
seem quite out of character with the circumstances of land use on the
island at the time; \index{drought}drought was never the serious
...
superintendent was to begin \index{drainage}drainage of its swamps.
The latter experience may have had significance for his private
interest in draining a swamp on the Derwent River\index{river!Derwent}
near Bridgewater,\index{Bridgewater, Tas.} upstream of Hobart though
...
Farm.\index{Marsh Farm} An embankment was constructed with
\index{technology!sluice gate}sluice gates to allow
\index{drainage}drainage to the river at low tide, preparatory to the
...
three to four feet at the highest spring tide.\fn{\cite{shaw1967};
\cite{mckay1962}; J.~Moore-Robinson, The Haunted House, \textit{Hobart
Mercury}, 6 July 1935.}
...
\begin{Quote}
	A noble embankment has been completed,
        \index{technology!dam}damming out the river effectually, which
        ...
        always afford an adequate supply of hay.\fn{\textit{Hobart
        Town Almanack 1830}, p.\,186.}
\end{Quote}
...
Henry Savery;\index{Savery, H.} its embankment also involved
\index{technology!sluice gate}sluice gates but no
...
apparently \index{drainage}drainage: wide internal drains were needed
as well as maintenance of the sluice gates.\fn{\cite{gowlland1980}.}
...
about \index{drainage}drainage of the swamp.  His letter tells of
advice given by James Blackburn,\index{Blackburn, J.} the engineer
then engaged on bridge construction nearby at Bridgewater, and by
Roderic O'Connor,\index{O'Connor, R.}  well known for his practical
...
Another use of irrigation, associated with
\index{technology!water-mill}water-powered mills, may have preceded
the \index{drainage}drainage of Governor Arthur's farm.  In one case,
relating to the property on the Derwent River \index{river!Derwent}
once known as Humphrey\-ville but later as Bushy Park,\index{Bushy
Park property} `extensive irrigation works with a flour mill' were
reported as installed about 1820 by the owner, Adolarius William Henry
Humphrey,\index{Humphrey, A,\,W.\,H.}  an important public servant.
...
bought by Ebenezer Shoobridge\index{Shoobridge, E.} in
1864.\fn{\cite{stancombe1968}; \cite[pp.\,56--58]{masoncox1994};
\cite{mckay1962}}

Irrigation in the Midlands\index{Midlands, Tas.} as early as 1825 has
...
\index{technology!channel} from a brook to his farm'. However,
...
`securing the embankment for his mill \index{technology!dam}dam', and
...
adequate water for his mill.\fn{\cite[p.\,138]{morgan1992};
J.\,C. Sutherland Diaries, TA, vol.\,1; \cite[p.\,64]{brown1941};
\cite[pp.\,22--23]{mckay1962}}

In 1829 there were 29 flour mills operating on the island, with all
\index{technology!water-mill} but four driven by water.  Practically
...
known to a Tasmanian writer, David Burn.\fn{\cite[p.\,129]{linge1979};
\cite[p.\,96]{burn1840}.}
...
WA} was established in 1830 on the banks of the Swan River in its
tidal reach but fresh water was available from local swamps and
springs.  Captain Frederick Irwin,\index{Irwin, F.} in charge of the
...
Mackie,\index{Mackie, W.} the advocate-general, he took up 3240\,acres
in the Swan River valley in 1829--30 and 7000\,acres near York on the
Avon River.\index{river!Avon} Their farm known as Henley
Park\index{Henley Park, WA} was on the Helena
River,\index{river!Helena} tributary to the Swan.  It was one of
...
boat from Fremantle
\index{Freemantle, WA} and Perth.  Guildford,\index{Guildford, WA} seven miles
northeast of Perth, became its main
township.\fn{\cite{mossenson1967};
\cite{honniball1967};
\cite[Appendix]{ogle1839}.}
...
as in farming, \index{gardening}gardening, brick-laying, lime-burning,
...
\begin{Quote}
	...
	constructing \index{technology!pipe!earthen}earthen pipes for
	...
	and as many sorts of \index{fruit}fruit-trees as have been
	...
	its beautiful fruit.\fn{\cite[pp.\,57--60]{irwin1835}.}
\end{Quote}
...
actually carried out.\fn{\cite{morgan1992}}
