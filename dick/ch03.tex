...
\addtoendnotes{\protect\subsection*{Chapter \thechapter}}

\fancyhead[RE]{\sffamily \small Chapter \thechapter. Tasmania}
...
Although dominated by use as a penal settlement, Tasmania attract\-ed
...
additional to other servants brought from \index{Britain}Britain or
\index{India}India. The settlement in Tasmania had a dual-purpose
nature: `both a free colony and a
gaol'.\fn{\cite[p.\,97]{roberts1924}; K. Fitzpatrick~(1967),
\textit{Aust.\ Dict.\ of Biography}, vol.\,1, p.\,413.}
...
adoption'.  Arthur Cotton,\index{Cotton, A.} an engineer who took a
...
natural \index{pasture}pasture and in \index{wheat}wheat-growing.  He
also wrote under a pseudonym in 1849 that for the previous fifteen
years in Tasmania, lucerne\index{fodder} under irrigation had
provided a cutting `about fifteen inches high every three weeks,
throughout the spring and summer'.\fn{\cite[p.\,348]{backhouse1843};
\cite{burn1840}; \cite{cotton1842}; \cite{cotton1849}.  `Delta' was
identified as Arthur Cotton by \cite{gordon1900}.}
...
estate} Reid gained success as a \index{wool}wool producer.  Ratho was
advertised for sale in 1837 with advice that the English grass
paddocks were then under irrigation from the Clyde.\fn{\textit{Hobart
Town Courier}, 20 Oct.\ 1837, as cited by
\cite[p.\,17]{masoncox1994}.}

Michael Fenton\index{Fenton, M.} (1789--1874) was probably the first
to combine irrigation with the use of a water-mill.
\index{technology!water-mill} He came to the island in 1828 after
...
Norfolk.\index{New Norfolk, Tas.} In 1829 he went to live on the
...
\begin{Quote}
	...
	soil.\fn{\cite{robson1967}; \cite[p.\,96]{burn1840}.}
\end{Quote}
...
on the Derwent River near New Norfolk.  The \textit{Austral-Asiatic
Review} claimed in 1843 that Bryant was the first settler in the
colony to practice irrigation.\fn{\cite[p.\,6]{masoncox1994}.}
...
tried irrigation on his Mona Vale\index{Mona Vale estate, Tas.} estate
in the Midlands, using water from a tributary of the Macquarie
...
Jamieson\index{Jamieson, D.}  irrigated \index{wheat}wheat before 1843
on his property, Glen Leith, near New Norfolk.  The property of
1800\,acres known as Blair on the Clyde River was advertised for sale
in 1843 on the death of its owner, William Allardyce,\index{Allardyce,
W.} with information that 60\,acres of English grasses were under
irrigation.\fn{\cite[p.\,40]{masoncox1994};
\cite[p.\,417]{strzelecki1845}; K.\,R.~von~Steiglitz, \textit{The
History Of Bothwell}, 1958, cited by \cite[p.\,26]{masoncox1994};
\cite[p.\,20]{masoncox1994}; `Bruni', `Irrigation in Tasmania',
\textit{Australasian}, 3 Nov.\ 1883; \textit{Hobart Town Courier}, 12
Nov.\ 1841.}
...
its area of 160\,acres included a \index{technology!dam}dam and
\index{technology!sluice gate}sluice gate with troughing erected for
irrigating the meadow land, through which the Back River flowed with a
sufficiency of water at all times to turn a mill.  The Ashby estate of
2800\,acres on the Macquarie River\index{river!Macquarie} was
advertised with the claim that following the successful outcome of
water conservation at Tooms Lake,\index{lake!Tooms} `a very large
...
irrigation: several farms to let in the Deloraine\index{Deloraine
district, Tas.} district, about 25\,miles west of Launceston, were
claimed as `being capable of irrigation'; another four properties were
similarly mentioned later.\fn{\textit{Hobart Town Courier}, 8 Mar.\
1840; \textit{Launceston Advertiser}, 18 Feb.\ 1841; \textit{Cornwall
...
irrigation'.\fn{\textit{Cornwall Chronicle}, 9 Apr.\ 1842.}  This may
be the earliest indication that irrigation in Tasmania might lead to
disputes over the \index{riparian rights}riparian rights of
landholders with river frontages.  However, irrigation in the early
1840s does not appear to have involved a very large area: half of the
dozen or so properties then involved no more than 2500\,acres under
irrigation.
...
\index{technology!tunnel}tunnel to provide more water.  It
is probable that irrigation at Dennistoun,\index{Dennistoun, Tas.}
also near the Clyde River, \index{river!Clyde} was begun in this
period.  Irrigation for hop-growing\index{hops} may have been started
by Ebenezer Shoobridge\index{Shoobridge, E.} about 1849 at Glen Ayr,
near Richmond.\fn{\noibidem\cite[pp.\,28, 24, 50]{masoncox1994};
\textit{Tas.\ J.\,Agric.~\& Hortic}., August (1860).}
...
Tas.}\fn{\noibidem\cite[p.\,30]{masoncox1994}.}

\section*{Motivation}

Tasmanian irrigation developed in response to favourable opportunities
for exports.  Sales of wool\index{wool} to \index{Britain}Britain
...
crossed Bass Strait to become squatters on new \index{sheep}sheep runs
south of the River Murray\index{river!Murray} or made settlements soon
designated as Melbourne\index{Melbourne, Vic.} and
Geelong\index{Geelong, Vic.}  on Port Phillip Bay.\index{Port Phillip
Bay} The initial success of \index{pasture}pastoralists in this part
of the mainland created a demand for \index{sheep}sheep to stock the
...
\index{wheat}wheat in Tasmania rose from 31\,156\,acres in 1830 to
...
assigned convicts.\fn{\cite[p.\,207]{fitzpatrick1941};
\cite[p.\,133]{hartwell1954}; \cite[p.\,445]{coghlan1918}.}

The principal use of irrigation in this period was to improve
\index{fodder}fodder production in summer and autumn for
\index{sheep}sheep and cattle. Summer grazing was available on river
...
\index{technology!water-mill}water-mills, so an association of milling and
irrigation developed in some places and proved advantageous in summer
and autumn.  Utilisation of low-lying areas by
\index{drainage}drainage combined with their irrigation in drier
...
\index{wheat}wheat, though rainfall in winter and spring was generally
...
\index{technology!flooding}flooding or `floating meadows' by Rowland
Vaughan\index{Vaughan, R.}  in Herefordshire during the 16th century.
...
Italy,\index{Italy} where relatively warm river water is applied to
...
\index{fodder}fodder.  This winter irrigation is referred to in
...
Pastures'.\fn{\cite[pp. 110--5]{kerridge1973};
\cite[p.\,1042]{mingay1989}.}
...
involved.\fn{\cite{blackburn1985}.}
...
widespread use of \index{technology!reservoir}reservoirs (tanks) to
conserve water for crop production in the dry season.  In Tasmania he
was thus able to advise on dams, water conservation, and irrigation
systems.  The full extent of his assistance to individual landholders
is unknown but many details of his activity in the Macquarie
River\index{river!Macquarie} valley have been recorded.  Before
returning to duty in India in 1840, Cotton set out his views on
irrigation in Tasmania in a paper published later by the Tasmanian
Society.  His statement notes the opportunities for irrigation in a
land where streams generally had either a lake or lagoon at their
headwaters, thus providing opportunities for storage by construction
of embankments or \index{technology!dam}dams.  He also gave estimates
of evaporation, detailed advice on construction of dams and races, and
discussed various mechanical ways of raising water from
streams.\fn{\cite{cotton1842}}
...
\begin{Quote}
	...
	upon them for this invaluable \index{Cotton, A.|)}treasure.
\end{Quote}
...
irrigation in a lecture on that subject given to the Hobart
\index{Mechanics' Institutes} Mechanics' Institute in July 1843.  On
...
on the extensive plains traversed by the Macquarie,
Elizabeth,\index{river!Elizabeth} and Lake Rivers;\index{river!Lake}
...
survey.\fn{H.\,C.~Cotton (1855), Lecture on Irrigation, delivered at
the Hall of the Mechanics' Institute, Hobart Town, July 14 1843,
Papers Relative to the Irrigation of Lands in Tasmania, Tas.\ Govt
Printer.}
...
in natural science.  Thus began the \index{Tasmanian Society}Tasmanian
...
including \index{Cotton, A.}Arthur Cotton and Paul
Strzelecki,\index{Strzelecki, P.} two men with marked interests in
...
as honorary members.\fn{\textit{Van Diemen's Land Chronicle} 30 July
1841; \cite{strzelecki1845}}
...
Midlands for State control of \index{technology!reservoir}reservoir
...
stagnant pools'.\fn{\cite{burn1840}}

All development began from William Kermode's\index{Kermode, W.}
ineffective efforts to irrigate from a \index{technology!dam}dam on
...
scheme for a \index{technology!canal}canal that would divert water to
the Blackman River\index{river!Blackman} from Lake
Sorell\index{lake!Sorell} at the west; this proved beyond the capacity
of the landowner.\fn{\cite[p.\,93]{masoncox1994}.}
...
\index{technology!dam}dam.  The promising scheme was put to a meeting
...
autumn.\fn{\textit{Hobart Town Courier}, 16 Apr.\ 1841.}
...
\index{technology!dam}dam with much greater capacity than Tooms Lake.
Before the year ended, Arthur Cotton \index{Cotton, A.} had returned
...
improve the \index{technology!dam}dam at Tooms Lake and to win
...
convicts.\fn{\textit{Launceston Examiner}, 18 Dec.\ 1847.}

The long-established system of convict assignment \index{convict
labour} to settlers end\-ed in 1840 on introduction of the
...
\index{technology!dam}dam at Long Marsh with a request that a
probation gang should be allocated for its erection.  This was agreed
to by Governor Franklin \index{Governor!Franklin} on the basis that
...
supply estimates for the \index{technology!dam}dam construction.
...
dam to be 70\,feet high.  Arthur Cotton \index{Cotton, A.} contributed
...
site, not long before his return to India.\fn{\textit{Launceston
Examiner}, 18 Dec.\ 1847, Boyes to Kermode;
\cite[p.\,69]{gowlland1980}; personal communication, R.\,W.~Gowlland.}

The barracks were completed in 1843 and work then began on the Long
Marsh \index{technology!dam}dam, to be 60\,feet high with the aim of
\index{technology!flooding}flooding an area greater than 400\,acres to
an average depth of 30\,feet.\fn{\cite{scarborough1975}.}
...
Long Marsh site and reported that the\index{technology!dam}dam was
under construction and might be finished by June 1845.  Governor
Eardley-Wilmot \index{Governor!Eardley-Wilmot} had directed Cotton to
...
all costs for use of convict labour \index{convict labour} at Long
...
\begin{Quote}
	...
	Marsh is an extensive flat, receiving the
	\index{drainage}drainage of a far greater tract of country
	than Tooms Lake; and may, by means of a short but high
	embankment, be made to retain 50 or 60 million cubic yards of
	water. This work was undertaken, and carried out to a certain
	extent by government labour, conjointly with private
	subscription, but has been discontinued.  The first work to be
	done is the completion of the embankment; and I give it in my
	plan a base sufficient for its being raised to a height of 80
	feet, when I calculate that it will retain all the water
	flowing into the marsh in one season.\fn{J. \& PP Tas.\ 1886,
	vol.\,IX, Paper~140, Irrigation: Report \& Estimates by Major
	Cotton, Longford 13 Jul.\ 1844.}
\end{Quote}

In that report, Cotton estimated that distribution of water to be held
in Tooms Lake and at Long Marsh by way of two main
\index{technology!channel}channels would allow irrigation of
18\,000\,acres near the Macquarie River and provide water to
Tunbridge, \index{Tunbridge, Tas.} Ross, \index{Ross, Tas.} and
Campbell Town, \index{Campbell Town, Tas.} all at a cost of
\pounds40\,000 using free labour.  He later reported that another
project using water to be retained in a
\index{technology!reservoir}reservoir proposed at Kearneys Bogs
\index{Kearneys Bogs, Tas.} on the Elizabeth River
\index{river!Elizabeth} would provide for irrigation of a further
20\,000\,acres.\fn{Cotton (1844); Tas.\ HA 1879, vol.\,37, Paper
no.\,69. Rept by H.\,C.~Cotton, 2 Apr.\ 1845.}

Repeated efforts were made over several years to resume construction
of the Long Marsh \index{technology!dam}dam, all without success.
...
on Mona Vale, \index{Mona Vale estate, Tas.} the large estate owned by
William Kermode. \index{Kermode, W.}  Strzelecki \index{Strzelecki,
P.} gave high praise to its farm improvements, especially the
\index{drainage}drainage of a marshy area and its irrigation with
water stored in Tooms Lake.\fn{\textit{Launceston Examiner} 18
Dec.~1947; \cite[pp.\,283--5]{strzelecki1845}.}  Another distinguished
...
Mundy. \index{Mundy, G.\,C.} He reported that
\begin{Quote}
	...
	\index{sheep}sheep as 15\,000 acres of the native pastures,
	...
	thus rendered available when and where \index{Long Marsh,
	Tas.|)}wanted.\fn{\cite[p.\,235]{mundy1852}.}
\end{Quote}

\section*{Governor Denison and Irrigation}

William Denison, a military engineer, became Governor
\index{Governor!Denison} in January 1847 and left that post in January
...
Hugh Cotton, \index{Cotton, H.} once in charge of the irrigation
survey, and contributed a paper in 1851 on \index{technology!dam}dams
...
rushes, \index{gold!rush} and constitutional issues.\fn{\cite[vol.\,1,
p.\,203]{denison1870}; Deas Thomson Papers, ML A1531--2, vol.\,II,
pp.\,534--546.}
...
for wool, \index{wool} and sale of \index{cereals}grain to the Sydney
...
\index{technology!dam}dam at Long Marsh.  That work was terminated
abruptly next year by Eardley-Wilmot, \index{Governor!Eardley-Wilmot}
...
Lake. \index{lake!Tooms}\index{Tasmania|)}
