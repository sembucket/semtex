...
\fancyhead[RE]{\sffamily \small Chapter \thechapter. Australian Mainland}
...
\index{wool}wool production that its number of \index{sheep}sheep
increased to 13 million in 1850.  At that time, the South Australian
colony, begun in 1836, held only a million \index{sheep}sheep.
Queensland was not separated from New South Wales until
1859.\fn{\cite[p.\,137]{fitzpatrick1941}.}
...
administered from Sydney \index{Sydney, NSW} and from Port Phillip
\index{Port Phillip, Vic.} and other places on the south coast.  Sheep
...
headquarters close to rivers but above \index{flood}flood level and
thus might irrigate small areas by pumping.  The only person known to
do this was J.\,L.~Phelps \index{Phelps, J.\,L.} of Canally,
\index{Canally, NSW} a pastoral station on the Murrumbidgee River
\index{river!Murrumbidgee} near its junction with the
Murray. \index{river!Murray} His practice was reported by Nehemiah
Bartley \index{Bartley, N.} who spent a few weeks at Canally in
November 1853:
\begin{Quote}
	...
	wooden \index{technology!pump!Californian}pump,
	...
	\index{gardening}garden.\fn{\cite[p.\,62]{bartley1892}.}
\end{Quote}

Irrigation was certainly used by the late 1840s at Buninyong,
\index{Buninyong, Vic.} 56~miles
...
producing \index{tallow}tallow by boiling down the carcases of their
\index{sheep}sheep.  Some cauldrons used in this process could hold
300 sheep.\fn{\cite[p.\,205]{roberts1935}.}  Francis Peter Labilliere,
\index{Labilliere, F.\,P.} an historian of early Victoria, described
...
\begin{Quote}
	...
	place on a limited scale.  He had a \index{technology!dam}dam
	thrown across a small creek, and with some
	\index{technology!sluice gate}sluices and trenches to convey
	...
	fields and splendid \index{vegetables}vegetables and
	\index{fruit}fruit in the
	garden.\fn{\cite[p.\,331]{labilliere1878}.}
\end{Quote}
...
considerable areas of land'.\fn{\cite[p.\,166]{billis1930}.}
...
Howitt \index{Howitt, A.\,W.} was relatively fortunate during his
travels to various goldfields in having support from
Lieutenant-Governor La Trobe \index{La Trobe, Lieut-Gov.} in the form
of introductions to several pastoralists, some of whom supplied
\index{vegetables}vegetables and \index{fruit}fruit to his party.
Prominent among these landholders were the Forlonges \index{Forlonges
family} of Seven Hills \index{Seven Hills, Vic.} (Euroa) \index{Euroa,
Vic.} in north-eastern Victoria.  Howitt called at their homestead in
the late summer of 1853 when water and \index{fodder}fodder for
\index{horses}horses were exceedingly scarce along the main road.  The
...
\begin{Quote}
	...
	six acres in extent and is full of splendid \index{fruit}fruit
	in season\,---\,loads of grapes and melons of all kinds
	especially.\fn{\cite[pp.\,146--7]{howitt1885}.}
\end{Quote}
...
\begin{Quote}
	...
	sale\ldots\fn{\cite[p.\,247]{howitt1885}.}
\end{Quote}
...
\index{Melbourne, Vic.} Geelong, \index{Geelong, Vic.}  Portland
\index{Portland, Vic.} and Port Fairy \index{Port Fairy, Vic.} in the
south, as well as inland at Bathurst \index{Bathurst, NSW} and
Goulburn. \index{Goulburn, NSW} Most of the farms involved would have
received rainfall generally sufficient for crops of \index{wheat}wheat
and \index{fodder}hay.
...
on his experience in \index{Italy}Italy to recommend use of irrigation
in Australia.  Thomas Mitchell \index{Mitchell, T.} was the first to
...
of forming \index{technology!reservoir}reservoirs of water' to be
...
and sugar'.\fn{\cite[pp.\,421--4]{mitchell1848}.}
...
\index{technology!railways}railways.  This may reflect Mitchell's
...
before the experience of the serious \index{drought}drought of
...
\begin{Quote}
	...
	\index{technology!canal}canals from the rivers will
	...
	before reaching the latter.\fn{\cite[p.\,4]{cunningham1841}.}
\end{Quote}
...
\begin{Quote}
	...
	this colony.\fn{\textit{Sydney Gazette}, 2 Sept.\ 1841.}
\end{Quote}
...
Kosciusko \index{Mount Kosciusko, NSW} helped to make his book
...
\index{Macarthur, J.} his companion on the exploration in the
Australian Alps but then involved with affairs of the Australian
Agricultural Company \index{Australian Agricultural Co.} which had
...
\index{Port Stephens, NSW} Strzelecki stayed at Port Stephens with
Phillip Parker King, \index{King, P.\,P.}  then in charge of the
...
block.\fn{\cite[p.\,263]{paszkowski1997}.}
...
\index{Italy}Italy and requested their circulation, apparently to
encourage use of the practice in Australia.  The Governor of New South
Wales, Sir Charles Fitzroy, \index{Governor!Fitzroy} apparently failed
to make a positive response to the documents.  However, the
lieutenant-governors of South Australia and Tasmania directed
publication in government gazettes.\fn{\cite[p.\,164]{lloyd1988}; SA
Govt Gazette, 28 Oct.\ 1847; \textit{Hobart Town Gazette}, 28 Sept.\
1847, cited by
\cite[p.\,114]{masoncox1994}.}
...
%various
types of irrigation and \index{drainage}drainage in northern Italy,
together with references to crops involved and the administrative
arrangements.  All this material covered the period 1804--1846.\fn{HRA
Series~I, vol.\,XXV, pp.\,457--79.}
...
was based at Buninyong, \index{Buninyong, Vic.} the site of his novel
...
\index{India} and Tasmania \index{Tasmania} and considered the main
...
the excavation of tanks (\index{technology!dam}dams) and diversion of
...
\index{technology!aqueduct} from marshes at the headwaters of the
Plenty River, \index{river!Plenty} a tributary to the Yarra, thus
...
\index{technology!reservoir}reservoir to be located in a natural
...
hundred acres from the \index{technology!aqueduct}aqueduct in the
...
construction of the Yan Yean \index{technology!reservoir}reservoir.
\index{reservoir!Yan Yean} Blackburn's scheme of water conservation
...
on Kangaroo Island \index{Kangaroo Island, SA} by the South Australian
...
margin of Gulf St Vincent \index{Gulf St Vincent, SA} had been
recognised by the official surveyors and the site for Adelaide
\index{Adelaide, SA} had been chosen after the River Torrens
\index{river!Torrens} had been discovered.  During inspections of the
coast in this region, John Morphett \index{Morphett, J.} in November
...
\begin{Quote}
	...
	advantage.\fn{\cite[p.\,12]{morphett1836}.}
\end{Quote}
...
\index{Mount Lofty Ranges, SA} proved invaluable as the source of
...
1838 with August Kavel, \index{Kavel, A.} their Lutheran pastor.  They
came to South Australia under the patronage of George Angas,
\index{Angas, G.} a major supporter of the new colony who advanced the
money for their transport. On arrival at Port Adelaide many were
suffering from \index{disease!scurvy}scurvy and all lacked proper
shelter and occupation. George Flaxman, \index{Flaxman, G.}  chief
...
to pay dearly for imported \index{cereals}cereals and
\index{vegetables}potatoes.  However, their settlement close to the
river gave access to water for domestic use,
\index{gardening}gardening, and livestock.  The Torrens flows strongly
for only six months of the year in response to high rainfall over its
headwaters; it then provided a good supply at Klemzig even in summer
from `a series of lakes connected by rivulets which in some places are
very narrow and in others shallow but which always ran briskly'.  At
that time Adelaide had a population greater than 5000 but Ferdinand
Kavel,
\index{Kavel, F.} 
...
did not like the watering'.\fn{\textit{South Australian Register}, 30
Jan.\ 1878;
\cite[p.\,96]{schubert1985}.}

Growing vegetables at Klemzig was a necessity to combat the
\index{disease!scurvy}scurvy contracted during the voyage to Australia.
Whether they carried water from the river up its steep bank or used a
pump is uncertain, but watering was a time-consuming task after
sundown, understandably so considering that in 1840 the
\index{gardening}gardens extended over almost seven acres. The
...
the \textit{Southern Australian} which mentioned lettuces, potatoes,
...
\index{gardening}gardening, a practice for which another
group\,---\,the Chinese\,---\,later achieved distinction throughout
Australia.\fn{\cite[pp.\,88, 97, 113, 131]{schubert1985}.}
...
Valley, \index{Barossa valley, SA} and his proposal early in 1839 for
...
seed gathered from his own garden on Kangaroo Island.  There appears
to be no evidence of Menge's involvement in the initiation of the
settlement at Klemzig, but it is improbable that Pastor Kavel and
...
\cite[p.\,29]{oneill1988}; \cite[p.\,96]{schubert1985}.}
...
1400\,acres at Moor\-undie, \index{Moorundie, SA} 70~miles north-east
of Adelaide.  Previously he had worked on pastoral holdings in New
South Wales, made two overland trips with livestock from that colony
to Adelaide, and gained distinction as an explorer\,---\,notably for
his epic journey in 1841 along the coast to Albany in Western
Australia.  Eyre's intention to resume life as a pastoralist had been
demonstrated in 1839 when he acquired land by the Murray; he was able
to occupy the holding after appointment by Governor Grey
\index{Governor!Grey} in September 1841 as Resident Magistrate on the
Murray and Protector of Aborigines, with a salary of \pounds300 a
year.  Grey's decision reflected concern at serious clashes earlier
that year between overlanders and \index{Aborigines} Aborigines near
the River Murray; it also recognised Eyre's reputation for good
relations with the natives and may have been intended as a reward for
his recent success in exploration at a time when he had no income.
...
Wellington, \index{Wellington, SA} but he was soon joined by
E.\,B. Scott, \index{Scott, E.\,B.}  his friend and companion on some
explorations, who also settled near the river and gave important help
to Eyre during residence there.  Early in 1842 Eyre set about
preparing to grow \index{wheat}wheat as well as arranging for the sale
of small allotments to provide a township.  Few sales were completed
and the projected town, to be named for Sturt the explorer, was never
...
settlement.\fn{\cite[p.\,152]{dutton1977}.}

Eyre's agricultural efforts suffered setbacks.  These derived partly
from his travels on duty as Protector of \index{Aborigines}Aborigines
and in the spring of 1842 when he was employed to search for a missing
settler on Eyre Peninsula. \index{Eyre Peninsula, SA} More
significantly there was marked variation in annual rainfall at
Moorundie and a serious risk of \index{flood}flooding by the river in
...
insufficient for cropping but in 1843 the \index{wheat}wheat grew
luxuriantly after good rains only to be ruined when the river flooded
from September to Nov\-ember.\fn{\cite{eyre1985}.}

Towards the end of 1842, Eyre had the satisfaction of raising a good
crop of \index{wheat}wheat from half an acre of land moistened by
soakage when the river level rose.  He proposed then to erect
\index{technology!sluice gate}sluice \index{technology!dam}dams across
\index{technology!channel}channels normally allowing
\index{technology!flooding}flood water entry to his river flats, so that
...
flooding of his land.\fn{\cite[p.\,14]{hawker1901}.}  The necessary
...
\begin{Quote}
	...
	\index{technology!dam}damming up the entrances by which the
	water escaped from the river to lower levels and in digging
	\index{technology!canal}canals for the purpose of
...
\begin{Quote}
	the ensuing year will I trust see these difficulties fully
        ...
        the highest \index{flood}flood\,---\,at the same time that a
        ...
        recommend\-ation.\fn{\cite[pp.\,67--9]{eyre1985}.}
\end{Quote}
...
lost and the balance cut for \index{fodder}hay.  This was Eyre's last
...
damage to his \index{technology!dam}dams; in 1856 the Moorundie
settlement was abandoned in favour of a higher site, several
kilometres upstream, where the township of Blanchetown
\index{Blanchetown, SA} developed.\fn{Moorundie and E.\,J.~Eyre, SRSA
item 951/9, Letter from Eyre to E.\,B.~Scott, 1 Nov.\ 1844.}
...
known as the Reed Beds. \index{Reed Beds, SA} By 1843 wheat-growing
\index{wheat} was well established in South Australia.  Its
cultivation then involved more than 23\,000\,acres, mainly on the
Adelaide \index{Adelaide, SA} plains, and exports of grain had begun.
The colony easily outstripped \index{cereals}cereal production in the
area later known as Victoria, which then had less than 5000\,acres
under \index{wheat}wheat and depended on imports of grain.  The spring
...
wheatgrowing.\fn{\cite[p.\,104]{dutton1892}; \textit{Commonwealth
Yearbook 1972}; \textit{Southern Australian}, 26 Dec.\ 1843.}
...
\begin{Quote}
	...
	Beds.  Of \index{fruit}fruit the produce is abundant, but the
	\index{wheat}wheat crops, generally good, are on some sections
	extraordinary. At Wymondlybury (Dr Addison's farm) the wheat
	crop is unusually heavy, that of the `White Talavera' standing
	about 6 feet in height, the ears exceedingly well filled, and
	several we have seen (plucked indiscriminately) measure seven
	inches in length.  The produce is estimated by competent
	judges at about 45 bushels per acre.\fn{\textit{Southern
	Australian}, 31 Dec.\ 1844.}
\end{Quote}

This farm, the property of Dr Joseph Addison, \index{Addison, J.}
covered 133\,acres on the north side of the River Torrens, the land
lies in the modern suburb of Fulham. \index{Fulham, SA} Addison then
had 42\,acres under \index{wheat}wheat. He was one of those medical
men who gave up their profession on migration to
Australia.\fn{J.\,B.~Cleland, \textit{Med.\ J.\,Aust.}, 29 Oct.\
(1938), p.\,732.}

Rainfall amounting in places to more than 40\,inches annually feeds
streams on both sides of the Mount Lofty ranges, and it was not long
...
\index{Strathalbyn, SA} 35 miles south-east of Adelaide, obtained land in
...
Creek, was known as Blackwood.  \index{Blackwood, SA} Before 1846,
...
crop'.\fn{\cite{stowe1973};
\cite[p.\,159]{dutton1892}.}
...
at Freshford\,---\,near Athelstone, \index{Freshford, SA}
\index{Athelstone, SA} seven miles from
Adelaide\,---\,using water from the River
Torrens.\fn{\cite{fornachon1958};
\cite[p.\,22]{bishop1977}.}

\closure Irrigation failed to secure a firm place on the mainland
where resources ---\,human and physical\,---\,were concentrated on
producing \index{wool}wool for export and essential foodstuffs:
\index{cereals|)}cereals and meat.  Only a few well-established men
