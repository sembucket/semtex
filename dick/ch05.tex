...
\section*{Water, Mining, and Miners} \index{gold!mining}
...
\index{technology!pump!Californian}pump, described by Howitt who
regarded it as of \index{technology!pump!Chinese}Chinese origin.
There was also recourse in these situations to temporary
\index{technology!dam}dams and races to deliver water as needed.  An
example in water control was given by miners who had gained experience
in \index{California}California.\fn{\cite[p.\,99]{howitt1885};
...
\index{Maryborough, Vic.} 396 at Ballarat, \index{Ballarat, Vic.} 266
in Gippsland, \index{Gippsland, Vic.} and 264 near Castlemaine.
\index{Castlemaine, Vic.} There were also many reservoirs constructed
in Victoria by the government and in New South Wales by private
companies.  Supervision of water use was a responsibility of officials
on mining fields; these were generally on land still held by the crown
so riparian rights \index{riparian rights} conferred by freehold land
title were rarely involved.  Disputes on mining fields over use of
water are thought to be largely responsible for some of the clashes
between \index{Europeans}European and Chinese \index{Chinese}
miners.\fn{\cite{smyth1869}; \textit{Vic.\ Yearbook 1973}, pp.\,161,
215; \cite[p.\,79]{lloyd1988}.}
...
sediment and excess water.  A further development was the
\index{gold!reef}reef mining, undertaken notably at Bendigo,
\index{Bendigo, Vic.|(} Victoria, one of the richest gold fields in
the world during 1870--90.  For this type of mining, often to depths
of several hundred feet, special machinery and engineering skills were
required.  Reef mining determined the persistence of mining in some
localities for decades, thus giving a basis for several large inland
towns with needs for water supply.
...
\index{Chinese}Chinese miners were numerous and distinctive on the
...
\index{Europeans}European protectors.  The more successful Chinese
...
population.  At first the \index{gold!rush}gold rushes drew men from
pastoral and agricultural activities.  Many shepherds left their
flocks and the area cultivated for \index{wheat}wheat at first
...
\index{horses}horses largely replaced bullocks, and
\index{technology!railways}railways were begun.  In Victoria
\index{Victoria} the number of horses \index{horses} rose from less
...
hay.\fn{\cite{howitt1885}; \textit{Vic.\ Yearbook 1973}, p.\,1090;
\cite{peel1974}.}
...
counties which included inland towns of Bathurst, \index{Bathurst,
NSW} Mudgee, \index{Mudgee, NSW} Goulburn, \index{Goulburn, NSW} and
Yass, \index{Yass, NSW} all served with
\index{technology!railways}railways by 1880.
...
\index{wheat}wheat by sea to other parts of the mainland as well as
developing trade to Victoria and New South Wales via the Murray
River. \index{river!Murray} Apart from \index{cereals}cereal
production, the Adelaide plains offered opportunities for
\index{fruit}orchards and \index{vineyards}vineyards.
...
\index{pasture}pasture for \index{sheep}sheep and is more detailed
...
gentlemen was supplied from Tooms Lake \index{lake!Tooms} since the
...
northern part of the island; where William Archer, \index{Archer, W.}
...
thousand acres near Deloraine.\fn{Tas.\ PP nos.~42, 43 of 1861;
...
Adelaide \index{Adelaide, SA} plains.  This stream is markedly
...
sufficient to power a saw-mill \index{technology!saw-mill} erected in
1839 at the end of this gully on the plain.  In 1854 Wilhelm and
Augustine Mugge rented \index{Mugge Bros} land in the gully and began
to establish their most successful nursery,
\index{gardening}market-garden and \index{fruit}orange grove which for
at least 30 years were sustained by water channelled from the creek.
Out on the plain, the same creek supplied
\index{technology!channel}channels and races made by the Clark family
to water their garden at Hazelwood.\fn{\cite[p.\,26]{warburton1981};
...
eight acres of \index{fruit}oranges and a \index{vineyards}vineyard at
Glynde \index{Glynde, SA} by 1866.  Further downstream, near the
Torrens, Rev.\ Thomas Stow \index{Stow, T.} diverted water to supply
his one-acre orangery, \index{fruit} established in 1854, and a
vineyard. \index{vineyards} At Morialta \index{Morialta, SA} on the
upper reaches of Fourth Creek, \index{creek!Fourth} John Baker
\index{Baker, J.} had vines, pear \index{fruit} trees and oranges
under irrigation by 1862.\fn{\textit{Adelaide Observer}, 21 July 1866,
...
servant, pumped water from it in 1862 for his bananas \index{fruit}
and three acres of oranges.  Dr C.\,G.~Everard \index{Everard, C.\,G.}
made a \index{technology!sluice gate}sluice at Ashford
\index{Ashford, SA} to carry creek water to his
garden.\fn{\cite[pp.\,50, 75]{ward1862}; \cite{priess1991}.}

Two owners of land bordering the foothills near Glen Osmond
\index{Glen Osmond, SA} used irrigation, even though they lacked
access to streams, by collecting runoff from their hills and springs
to supply \index{vineyards}vines, oranges and other \index{fruit}fruit
trees.  One was Arthur Hardy \index{Hardy, A.} of Birksgate;
\index{Birksgate, SA} the other William Milne \index{Milne, W.} at
Sunnyside, near Beaumont.\fn{\cite[pp.\,24,
55]{ward1862}.}\index{Beaumont, SA}

To the west of Adelaide, A.\,H.~Davies \index{Davies, A.\,H.} began
irrigation in 1861 by using a double-action horse-driven pump
\index{technology!pump!horse-powered} at his
well on Moore Farm \index{Moore Farm, SA} near Lockleys
\index{Lockleys, SA}
and running the flow through galvanised
\index{technology!pipe!galvanised}pipes laid on the ground to
serve his trees and shrubs.\fn{\cite[p.\,15]{ward1862}.}

Only a few irrigators beyond the Adelaide district were known in 1862
to Ebenezer Ward.  \index{Ward, E.} Mr~Winckel was irrigating
\index{fruit}fruit trees near \index{Gawler, SA}Gawler and Joseph Gilbert
\index{Gilbert, J.} had prepared a small reservoir for irrigation in
the Barossa \index{Barossa valley, SA} district, apparently at Pewsey
...
gates. \index{technology!sluice gate} It was at Langhorne
Creek, \index{creek!Langhorne} east of the Mount Lofty Ranges, that
the Potts family started to irrigate, at first using a pump driven by
\index{technology!pump!horse-powered}horse power and
later, in the 1860s, with a distinctive system for diverting water
from the Bremer river to \index{technology!flooding}inundate their
Bleasdale \index{Bleasdale, SA}
\index{vineyards}vineyard.\fn{\textit{SA Weekly Chronicle} 24 Aug.\
1876; \cite{smith1950}.}
...
Sydney,\index{Sydney, NSW} J.\,R.~Atkinson \index{Atkinson, J.\,R.}
...
\index{technology!pump!centrifugal} to raise water 15\,feet from a
creek for irrigation.  At Bodalla \index{Bodalla, NSW} on the south
coast, the well-known entrepreneur Thomas Mort \index{Mort, T.} had
drained swampy land for his \index{dairy}dairy farm only to find a
need for irrigation during the serious \index{drought}drought of
1863--65.  He ordered a horse-drawn pump
\index{technology!pump!horse-powered} from England with the intention
of using it for irrigation on the Tuross River \index{river!Tuross}
flats, by means of a long hose fitted in turn to seven outlets from a
branching system of pipes.  In this way he expected to water up to
45\,acres.

The irrigation before 1855 by Phelps at Canally \index{Canally, NSW}
in the far west of New South Wales was followed in the 1860s by the
supply of water to an orchard \index{fruit} and
\index{gardening}garden on the Murray Downs \index{Murray Downs, NSW}
pastoral station across the Murray from the Victorian town of Swan
Hill. \index{Swan Hill, Vic.} Suetonius Officer \index{Officer, S.}
had taken over this holding in 1862 and lived there until 1881.  He
`installed pumps worked by horses,
\index{technology!wind-mill}wind-mills and later steam pumps
\index{technology!pump!steam-driven} and irrigated large paddocks for
lucerne \index{fodder} and maize \index{maize} as well as orchards and
groves of \index{fruit}Jaffa oranges' apparently established by 1867.
Another early irrigator in that region was the pastoralist
D.\,H.~Cudmore \index{Cudmore, D.\,H.} who told a Victorian Royal
Commission in 1896 of his irrigation of lucerne and other crops with
Darling River \index{river!Darling} water for `the past 26
years'.\fn{\textit{J.\,R.~Aust.\ Hist.\ Soc.}, vol.\,34, (1948),
p.\,387; \textit{Australasian}, 23 Sept.\ 1871, `Irrigation', by
T.\,Bath, p.\,409; Personal communication, C.~Mort, (1992);
\cite{hone1967}; G.\,K.~Chapman, \textit{Vict.\ Hist.\ Mag.},
vol.\,22, (1947), p.\,1; Vic.\ RC~Veg.\ Products, 4th Prog.\ Rept,
(1887), p.\,109; Vic.\ PP no.\,19 of 1896, RC~Mildura, MoE, p.\,16.}
...
been started near Melbourne \index{Melbourne, Vic.} and in parts of
western Victoria including the bank of the Murray River
\index{river!Murray} close to South Australia.  Possibly the earliest
record of Victorian irrigation in this period concerns Rev.\ Thomas
Goodwin, \index{Goodwin, T.} an Englishman who travelled to Victoria
in 1852 and undertook an Anglican mission to
\index{Aborigines}Aborigines.\fn{\cite[p.\,13]{massola1970}.}
\begin{Quote}
	...
	\index{technology!pump!hand} In a few years after
	I found it necessary to construct a wind-mill
	\index{technology!wind-mill} for the working of this
...
\index{gardening}gardens `had to be pumped from 20 to 30 feet,
according to the height of the \index{flood}flood'.  Aborigines
\index{Aborigines} undertook some of the cultivation; Goodwin reported
in 1863 that `some achieved quite a degree of success in this
pursuit'.\fn{\noibidem\cite{massola1970}}

This achievement and the earlier success on the Murrumbidgee
\index{river!Murrumbidgee}at Canally \index{Canally, NSW} with
small-scale irrigation may have spurred others to follow their
example.  This probably happened in the case of the well-known
\index{gardening}garden and \index{fruit}orchard started by the
Jamieson brothers on the Victorian side of the Murray River
\index{river!Murray} at Mildura, \index{Mildura, Vic.} the pastoral
station they held from 1847 to 1874.  Their garden apparently became
known to travellers on the river-boats \index{technology!river-boat}
by the 1870s and it is claimed that Captain Barber of the
\textit{Cumberoona} obtained \index{fruit}fruit from Mildura in
1874.\fn{\cite{hill1937}; \cite[p.\,233]{mudie1965}.}
...
Melbourne, in 1857, using a hand-pump \index{technology!pump!hand} to
draw a supply from the Maribyrnong river. \index{river!Maribyrnong} At
first he held only seven acres of land under lease; later he brought
more than 45\,acres, increased his orchard area, and used
\index{horses}horse power \index{technology!pump!horse-powered} for
pumping.  Then in 1870 he purchased an additional 70\,acres, planted
more \index{fruit}fruit trees, and erected a chain water-lifter worked
by horse power.  This was supplemented by a wind-mill
\index{technology!wind-mill} to pump water. His last improvement for
delivering water was to make a weir \index{technology!weir} across the
stream and install hydraulic rams.\fn{\textit{Procs First Vic.\
Irrig.\ Conf}.~1890; \textit{Aqua}, vol.\,10, (1959), p.\,189, \&
vol.\,13, p.\,152.}

Others at the 1890 conference of irrigators who referred to their
early use of irrigation were G.~Eason \index{Eason, G.} who in 1858
took water from a spring near Buninyong \index{Buninyong, Vic.} to
irrigate \index{vegetables}vegetables at first and later established
\index{fruit}fruit trees; John Garden \index{Garden, J.}  who
irrigated vines \index{vineyards} at Taradale \index{Taradale, Vic.}
in 1861; Charles Hugh Lyon \index{Lyon, C.\,H.} who irrigated at
Ballan \index{Ballan, Vic.} on the property he held there from 1853 to
1866; T.\,G.~Pearce \index{Pearce, T.\,G.} who began irrigating at
Bacchus Marsh \index{Bacchus Marsh, Vic.|(} in 1867; and Daniel Vince
\index{Vince, D.} whose \index{fruit}orchard at Bridgewater
\index{Bridgewater, Vic.} was first irrigated about
1865.\fn{\cite[p.\,170]{billis1930}; \textit{Procs First Vic.\ Irrig.\
Conf}.~(1890).}
...
\index{Young, J.} in 1866 as an irrigator some six years previously.
Another reference to early irrigation is given in the report of a
resources survey undertaken by the Philosophical Institute in 1860.
It mentions irrigation of potatoes at Glendaruel, \index{Glendaruel,
Vic.} near the Clunes goldfield.\fn{\cite{acheson1860}; J.~Young,
`Irrigation', A lecture delivered in the Mechanics' Institute, Bacchus
Marsh, 28 Sept.\ 1866; \textit{Trans.\ Phil.\ Inst.\ Vic.}, vol.\,4,
(1860).}
...
double-action pump \index{technology!pump!steam-driven} to raise about
200\,gallons per hour through a main \index{technology!pipe}pipe to an
earthen storage \index{technology!dam}dam of large capacity on the
high ground.  Water then gravitated through underground pipes to
outlets at intervals of 78\,yards, from which two men could water the
land with a hose at the rate of five acres per day.  Ricardo's
...
surface \index{technology!channel}channels and required levelling of
the ground.  Late in 1860 this alternative system was tried on the
first area to be prepared\,---\,approximately 10\,acres.  This
undertaking had involved employment of an irrigation engineer and the
outlay of several thousand pounds for equipment and earthworks.  When
complete it would have allowed irrigation of
100\,acres.\fn{\cite[p.\,174]{thomson1972}; \textit{Victorian Farmers
Journal and Gardeners' Friend}, 7 July 1860.}
...
orchard, \index{fruit} garden, \index{gardening} and a vineyard
\index{vineyards} of excellent varieties which had previously produced
thirty hogsheads of wine annually.  O'Keefe used irrigation at
Adelaide Vale for dairy \index{dairy} production in the 1870s.  A
...
homestead. Their irrigation of lucerne \index{fodder} in 1860--61 was
reported by G.~Graham.\fn{\cite{brown1967}; Footnote, A.\,S. Kenyon,
\textit{J.\,Agric.\ Vic.}, vol.\,10, (1912),
pp.\,658--661.}\index{Graham, G.}

Probably the largest single area under irrigation during this period
in Victoria was the 500\,acres of sown \index{pasture}pasture watered
in summer by Thomas Bath \index{Bath, T.} from Lake Learmonth
\index{lake!Learmonth} in the Ballarat \index{Ballarat, Vic.}
district from 1867.\fn{\textit{Australasian}, 23 Sep.\ 1871, p.\,409.}

Information on the irrigation of \index{vegetables}vegetables in this
period is very limited.  Chinese miners \index{Chinese} grew
...
excrement. \index{human excrement} An early reference to Chinese
\index{gardening}gardening on the Ballarat goldfields appeared in the
...
Market-gardening \index{gardening} by Chinese and
\index{Europeans}Europeans began to flourish as the population
increased; the number of Chinese market-gardeners at Ballarat
\index{Ballarat, Vic.} in 1868 was given as 150.  In the Melbourne
suburb of Brighton, \index{Brighton, Vic.}  market-gardening by
...
from shallow wells.\fn{\cite{cannon1974}; \textit{Ill.\ Aust.\ News},
1 Jan.\ 1869.}
...
The variety of \index{gardening}garden produce offered by Chinese in
...
\begin{Quote}
	...
	bunches of grapes and baskets of tomatoes, \index{fruit}fruits
	and flowers in plenty, and at cheap rates. They became
	teachers of the people.\fn{\cite[pp.\,31--32]{booth1873}.}
\end{Quote}

Details of irrigation undertaken by Chinese or
\index{Europeans}European market gardeners in this period have not
...
irrigation.  He gave details of irrigation in \index{Italy}Italy and
\index{India}India, referred to the use of sewerage water near Milan
and Edinburgh, and recommended the adoption of a scheme which he was
confident `holds out the prospect of increased prosperity to the great
staple interests of New South Wales'.  A long report of Denison's
paper was published in the \emph{Sydney Morning Herald} of 13 Nov.\
1856 and a short report was given in the \emph{Melbourne Argus} of 1
Dec.\ 1856.
...
\index{technology!channel}channels to distribute water from
...
\index{Mechanics' Institutes} and papers read at meetings of scientific
societies.  So, in 1860, John Julius Stutzer, \index{Stutzer, J.\,J.}
...
England and \index{Italy}Italy and mentioned Tasmanian attention to
the use of Blackman River, \index{river!Blackman} which might be
supplied from Lake Sorell \index{lake!Sorell} by means of a connecting
\index{technology!tunnel}tunnel.  Soon after this Stutzer
transferred to Victoria to become editor firstly of the weekly
\textit{Yeoman and Australian Acclimatizer} and later of the
\textit{Australasian}.  In 1857 H.\,M.~Hull, \index{Hull, H.\,M.}
erstwhile colleague of Denison, addressed the Royal Society of
Tasmania \index{Royal Society!Tasmania} on irrigation in the district
...
miles north of Bacchus Marsh, with distribution by
\index{technology!channel}channels.  The scheme had been
put to the Minister (Mr~Sullivan) with favourable response, and now
required the potential ratepayers for irrigation to guarantee
repayment of funds advanced.  This scheme was not realised but
irrigation at the Marsh was soon used by several
...
with numerous appendices runs to nearly 120 pages.\fn{Vic.\ PP no.\,48
of 1871.}
...
\index{technology!channel}channels but irrigation should
...
and patience are in these matters necessary'.\fn{\cite[quotation,
pp.81--82]{powell1989}; Vic.\ PP no.\,48 of 1871, appendix no.\,28,
p.\,113.}
...
\index{technology!canal}canals for irrigation and
navigation between the Tungabhadra River \index{India} and the coast,
...
engineer for the Victorian Board of Land and Works.\fn{George Gordon
papers, LaTL.}

Detailed proposals for greater use of irrigation in Tasmania
\index{Tasmania} received attention by legislators in 1861.  In July
1860, the Governor, Sir Henry Young, \index{Governor!Young} opened the
parliamentary session and announced the Government's intention to
introduce legislation concerning irrigation.  Isaac Sherwin,
\index{Sherwin, I.} a prominent irrigator and member of the House of
...
its work was criticised as slovenly by the \textit{Hobart Mercury}.  A
fresh approach was made in the House of Assembly during October by
William Archer \index{Archer, W.} and Dr~Officer, with the result that
an Irrigation Commission was agreed on and its members were appointed
by the Governor.  These were Philip Gell, \index{Gell, P.} who had
worked on the irrigation survey of the 1840s, and William Langdon,
\index{Langdon, W.} both from the Legislative Council; William Archer,
\index{Archer, W.} James Maclanachan \index{Maclanachan, J.} and
Dr~Robert Officer \index{Officer, R.} from the House of Assembly,
together with Richard Dry, \index{Dry, R.}  erstwhile legislator, and
the Surveyor-General, James Erskine\index{Calder, J.\,E.}
Calder.\fn{\textit{Hobart Mercury}, 10 Aug., 2 Oct., 31 Oct., 6 Nov.\
1860.}
...
\index{Martelli, A.}  concerning Tasmanian irrigation, Major Cotton's
\index{Cotton, A.}  reports in the 1840s, and three draft Bills
dealing with irrigation.  Martelli's further report was also presented
as Paper no.~43 at the same time.  In it he provided proposals for
greater use of irrigation in addition to the fairly detailed
statement, referred to above, of existing irrigation in the Derwent
valley. \index{irrigation!scheme!Derwent valley} He detailed the cost
of works in the Derwent valley to provide for a Weasel Plains
\index{technology!channel}channel, \index{Weasel Plains, Tas.}
irrigating 4000\,acres and supply water to the town of Bothwell,
\index{Bothwell, Tas.} a High Plains channel irrigating 6000\,acres
and supplying the town of Hamilton, \index{Hamilton, Tas.} and a
Derwent \index{technology!channel}channel to irrigate 800\,acres to
the plains opposite New Norfolk.  \index{New Norfolk, Tas.} These
works together with improvements to existing irrigation on three
larger properties would enable almost 15\,000\,acres to be
...
installation of drains or irrigation
\index{technology!channel}channels by a landowner across
...
\index{technology!canal|(}
\index{canal!scheme!Vic.|(}
...
The entry of \index{pasture}pastoralists \index{pastoralists} into
northern Victoria completed the occupation by squatters
\index{squatters} of all land in the colony suitable for grazing.
...
\index{technology!railways}railway was the line from Melbourne to
Bendigo \index{Bendigo, Vic.} thence along the Campaspe River
\index{river!Campaspe} to Echuca.  \index{Echuca, Vic.}  Settlement
along this stream gave rise to the towns of Rochester
\index{Rochester, Vic.} and Elmore, \index{Elmore, Vic.}  with Bendigo
as the virtual capital of the region.

Canals had previously been suggested for different parts of Australia:
for inland \index{technology!canal}irrigation or transport and for
shipping near the coast.  The early proposals were inspired by
widespread use of canals in \index{Europe}Europe before the success of
\index{technology!railways}railways.  Benjamin Hawkins Dods
\index{Dods, B.\,H.}  (1834--1896) initiated the Victorian canal
scheme.  He came to Australia from \index{Scotland}Scotland in 1849,
...
westward to the Mallee country \index{Mallee district} from the
Goulburn River. \index{river!Goulburn} That perennial stream, wide and
deep enough to require ferries at crossing places, was used by
\index{technology!paddle-steamer}paddle-steamers in the 1870s and
1880s to carry \index{wool}wool and \index{wheat}wheat down to Echuca
\index{Echuca, Vic.} on the Murray. \index{river!Murray} Occasionally
it generated \index{flood}floods, the record being in
...
profit.\fn{\cite[p.\,214]{flett1970}; \cite[p.\,50]{buxton1967}.}

Dods and three others applied to the Minister of Lands, J.~McPherson,
\index{McPherson, J.}  in May 1871, before widespread alienation of
crown land had occurred, for a grant or lease for 999 years of three
million acres with a frontage to a \index{technology!canal}canal
60\,feet wide extending from the Goulburn River \index{river!Goulburn}
westward to lakes in the Mallee district. \index{Mallee district}
Their application was made under a section of the Land Act 1869
\index{legislation!Vic.!Land Act 1869} which allowed for the granting
of leases of crown land `to any person willing to make and construct
canals'.  The three men joined with Dods in the application included
William McCulloch, \index{McCulloch, W.}  owner of the largest company
carrying freight by road and river in northern Victoria, and Hugh
Parker, \index{Parker, H.}  partner of the woolbroker Richard
Goldsborough.  \index{Goldsborough, R.} The Minister was promptly
advised by his departmental secretary, Clement Hodgkinson,
\index{Hodgkinson, C.} a surveyor and engineer, that the scheme had
merit and warranted \index{finance}financial support but not to the
extent of the very large grant of land being sought.  McPherson
...
Company.  As far as irrigation was concerned, the prospectus of the
company indicated that the northern plains would receive water for
cultivated crops and for intensified livestock production.  The land
...
chicory, wheat, oats, barley, tobacco, and
fruit.\fn{\cite[p.\,23]{martin1955}; J.\,H.~McColl, \textit{Vict.\
Hist.\ Mag.}, vol.\,V, (1917), p.\,145; \cite[p.\,87]{powell1989};
J.\,N.~Churchyard, \textit{Aqua}, vol.\,7, (1956), p.\,268.}
...
\index{Sankey, R.\,H.}  offered his opinion.  While the purpose of his
visit was to give advice on the Coliban and Geelong schemes for water
conservation, he had been invited to comment on other aspects of water
supply in the colony.  Sankey found that a
\index{technology!canal}canal supplying water to irrigate
six million acres would need to be wider than any existing irrigation
canal in the world.  His scornful criticism caused Dods to sue for
defamation, claiming \pounds2000 but ultimately settling for \pounds40
just before Sankey's departure from the colony in September
1871. Sankey's opinion led to some withdrawal of support for the
scheme and as the agricultural use of northern Victoria was favoured
by good rains for several years, interest in irrigation declined and
the scheme languished until later.  Meanwhile, railways
\index{technology!railways} were being extended into parts of northern
Victoria.\fn{Vic.\ PP no.\,48 of 1871, Appendix~28.}

A meeting of 300 people at Bendigo in September 1874 almost
unanimously endorsed further action on the scheme.  Hugh McColl
\index{McColl, H.}  (1819--1885) became secretary of the company and
...
\index{Casey, J.\,J.} of Bendigo, by another local parliamentarian,
Robert Burrowes. \index{Burrowes, R.}  The Minister agreed to look
...
\index{technology!canal}canal directed northwesterly far
...
\index{finance}financial success of the scheme, with the conclusion
...
present'.\fn{Vic.\ PP no.\,20 of 1880--81, vol.\,2, Northwestern
Canal.}

Hugh McColl persevered with the \index{technology!canal}canal scheme,
...
publications dealing with Californian \index{California} canal
...
Gustav Thureau \index{Thureau, G.} to collect pertinent information
during his visit in 1877 to the \index{USA}USA on behalf of
\index{Bendigo, Vic.|)}Bendigo mining interests.\fn{D.~Worster,
\textit{Agric.\ History}, vol.\,56, (1982), p.\,503--509.;
\cite[p.\,78]{blainey1963}; \textit{Australasian} 2 Mar.\ 1878,
p.\,282, letter from G.~Thureau.}
...
Meanwhile, George \index{Gordon, G.}Gordon along with many other
public servants was dismissed in 1878 ostensibly as a measure of
economy.  His efforts to gain reinstatement were fruitless but he had
the opportunity in 1879 to make public his own views in statements on
water supply and irrigation.  His Ballarat lecture on irrigation
addressed many aspects relevant to conditions in northern
Victoria.\fn{G.~Gordon, Lecture on Irrigation and Drainage, Ballarat,
(1878).}
...
and irrigation, never missing an opportunity to advocate the
\index{technology!canal}canal project.  His major success
was to win support for schemes of irrigation in northern Victoria,
with involvement of canals filled with water from the Goulburn
River. \index{river!Goulburn}
...
manufacturer of jam.  He had a \index{gardening}garden in the suburb
of Mitcham \index{Mitcham, SA} which he later proposed to irrigate.
...
variation of existing \index{riparian rights}riparian rights.  The
...
second reading.\fn{\cite[p.\,174]{ward1862}.}
...
\closure Records of irrigation in three colonies on the mainland show
...
human labour, \index{horses}horse power, wind power,
...
with an extensive
\index{canal!scheme!Vic.|)}\index{technology!canal|)}canal.
