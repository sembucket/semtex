...
and did not start until the \index{drought}drought year of 1902.  The
...
Valley \index{river!Loddon} and the adjacent
\index{district!Gunbower}Gunbower district where
...
and provision of distribution \index{technology!channel}channels. The
...
campaign to attract settlers\,---\,with some success.  The \index{Hay,
NSW}Hay Irrigation Trust, \index{trust!irrigation!Hay} also under
...
(1896), pp.\,469--70; \cite[p.\ 113]{jeffcoat1988};
\cite{williamson1968}.}
