...
\index{riparian rights}riparian rights, an important prelude to
...
South Wales followed the widespread \index{drought}drought of 1902 and
...
adopt irrigation.\fn{\cite[p.\,121]{powell1989}.}

The Water Act of \index{legislation!Vic.!Water Act 1905} 1905 provided
for establishment of a new authority\,---\,the State Rivers and Water
Supply Commission (SRWSC)\,---\,to control \index{State Rivers \&
Water Sup.\ Comm., (SRWSC) Vic.} surface water resources of Victoria
...
\index{legislation!Vic.!Irrig.\ Act 1886} which left intact those
\index{riparian rights}riparian rights established previously and thus
limited the power of the government to make
\index{technology!reservoir}reservoirs in the head waters of any
...
\index{river!Glenelg} flowing from the Grampians mountains in western
...
riparian rights and expense.  Existing \index{riparian rights}riparian
...
domestic use.\fn{S.~Murray (1889), quoted by L.\,R.~East in
\textit{Aqua} vol.\,9, (1958), p.\,248; \noibidem\cite[fig.\,35,
p.\,148, p.\,150 re W.\,S.~Manifold]{powell1989}; Vic. PD vol.\,110, 30
Aug.\ 1905, pp.\,1247--8; L.\,R. East, \textit{Vic.\ Hist.\ Mag}.,
(1967), p.\,182; A.~Deakin, \textit{Yearbook of Australia}, (1892),
p.\,9.}
...
River by \index{technology!pump}pumping and many permits
...
24\,000\,acres.\fn{\cite[p.\,54]{mccoy1988}; Vic.\ PP, Ann.\ Repts
SRWSC 1906--7, 1914--15, also E.~Mead, \textit{BAAS Hdbk Vic.},
(1914), p.\,266.}

The provision of stock and domestic supplies by the SRWSC became a
major undertaking as an extensive system of earthen
\index{technology!channel}channels was developed by 1914 to serve
\index{wheat}wheat-growing farms in northwestern Victoria, an area
largely devoid of useful streams. That system was for many years
largely dependent on supplies from
\index{technology!reservoir}reservoirs filled from the Grampians, with
the consequence that irrigation could not then be extended further in
the nearby \index{district!Wimmera}Wimmera district.\fn{L.\,R.~East,
\textit{Vic.\ Hist.\ Mag.}, vol.\,3, no.\,8, (1967), p.\,205;
\cite{mcnab1944}.}
...
land values but in 1909 the Water Act \index{legislation!Vic.!Water
Act 1909} was amended to provide a scale of water-rights according to
...
in force for many years.\fn{Vic.\ Water Act 1905, 1909, and 1915.}
...
\index{technology!channel}channels and works necessary for irrigation
...
to attract settlers from \index{Europe}Europe and
\index{America}America.\fn{Ann.\ Rept SRWSC 1908; \cite[J.~Rutherford,
p.\,126]{powell1974}.}
...
with water by \index{technology!pump}pumping from the nearby River
\index{river!Murray}Murray.\fn{S.~Whitehead, \textit{BAAS Hdbk Vic.},
(1914), p.\,95.}
...
\index{Chaffey Bros}Brothers for irrigation development at Mildura.
Plans for subdivision were made in 1908 and next year the SRWSC
offered 150 blocks for selection in an area of 5000\,acres.  The
Commission intended \index{dairy}dairying to be the main industry,
based on \index{fodder}lucerne irrigated with water lifted about
90\,feet from the River Murray.  By 1914 there were 182 blocks
...
for \index{fruit!dried}dried fruit during the 1914--18 war this
commodity became the main product of the settlement.  Extensions to
the irrigated area began in 1917 for settlement of war veterans,
including one portion known as Birdwoodton which occupied part of the
concession area granted to the Chaffey Brothers in the 1880s at
Mildura.\fn{E.~Mead, \textit{BAAS Hdbk Vic.}, (1914), p.\,265;
\cite[p.\,265]{wells1986}; \cite{mcintyre1948}; \textit{CSIR Bull}.\
no.\,123, (1939), Merbein Rept.}
...
settlement was \index{fruit!dried} fruit.  Irrigation depended on
\index{technology!pump}pumping from the river to a height
of 80\,feet.\fn{E.~Mead (1914), \textit{op.\ cit.}; \textit{CSIR
Bull}.\ no.\,73, (1933).}

Experiments significant for Australian irrigation of \index{rice}rice
though apparently started without provision of irrigation by the SRWSC
were conducted for several years by the Japanese immigrant
...
land subject to \index{flood}flooding and ultimately succeeded in 1911
in raising \index{rice}rice from seed sown directly in the ground.
Seed that he had raised was apparently used by another grower at
Koyuga, where the crop sown in November 1915 and watered weekly from a
special \index{technology!dam}dam filled from irrigation
\index{technology!channel}channels gave a marketable yield
of grain impressive enough for others in the district to start sowing
\index{rice}rice.\fn{\cite{sissons1990}; \cite[p.\,117]{scholes1989};
The Australian Encyclopedia, (1927), article on rice; T.~Smith,
\textit{J.\,Agric.\ Vic.}, vol.\,14, (1916), p.\,493.}
...
Basin and the Western Waranga Main \index{channel!Western Waranga
Main}Channel, then being extended towards the Loddon Valley which it
reached at Serpentine Creek \index{creek!Serpentine} in 1912.  The new
irrigation settlements stood like islands in a region largely used for
\index{cereals}cereal growing and pastures with supplementary
...
\index{fodder}lucerne near Shepparton, Kyabram, Tongala, and
Rochester.\fn{\cite[p.\,16]{mccoy1988}; E.~Mead (1914),
\textit{op.\,cit}.}
...
along \index{creek!Gunbower}Gunbower Creek; near Swan Hill using water
pumped from the \index{river!Murray}Murray; and at Werribee in central
Victoria where an irrigation settlement occupying 6000\,acres and
supplied with water from the \index{river!Werribee}Werribee River was
opened in 1912, following construction of a \index{reservoir!Pykes
Creek}\index{technology!reservoir}reservoir at
\index{creek!Pykes}Pykes Creek in 1911.\fn{\textit{Aqua}, Jan.\
(1969); \cite[pp.\,86, 90, 97]{james1985}.}
...
\index{Europe}Europe and Nor\-th \index{America}America for six months
...
\index{Russians}Russian Jews near Shepparton, but in 1914 there were
...
\index{district!Cohuna}Cohuna district, of which 1200\,acres in the
locality known as Mead had been so affected by salinity
\index{salinity} as to render the land temporarily unfit for
...
\index{drought}drought of 1914 showed that the success of irrigation
...
and to build a new \index{technology!dam}dam on the upper Goulburn
River. \index{river!Goulburn} In addition, the supply of irrigation
...
of the Hume Dam \index{dam!Hume} \index{weir!Torrumbarry} and the
Torrumbarry Weir.\fn{\cite[pp.\,131--33]{broome1984};
\cite[pp.\,116--24]{scholes1989}; \cite{coulson1995};
\cite{trevaks1937}; Mead (1914) \textit{op.\ cit.}, p.\,265;
\textit{Melbourne Argus}, 20 Mar.\ 1913, p.\,15; Vic.\ PP RC~Closer
Settlement 1916, Final Rept; \cite[p.\,99]{keating1992};
\cite[p.97]{forster1965}.}

The first world war and the departure of Elwood Mead \index{Mead,
E.|)} in 1915 led to some reduction of efforts by the SRWSC until in
1918, following the Closer Settlement Act,
\index{legislation!Vic.!Closer Settlement Act 1918} it became
...
Cliffs, \index{Red Cliffs, Vic.} for which A.\,S.~Kenyon
\index{Kenyon, A.\,S.}  at the end of 1918 proposed the development by
...
\index{technology!pump}pumped from the river began in 1921.  Red
Cliffs later included more than 700 allotments held mainly by
discharged soldiers for production of dried
\index{fruit!dried}fruit.\fn{\cite[p.\,14]{mccoy1988}; A.\,J.~Tisdall,
`Irrigation in Victoria', in \textit{Water Resources Use and
Management}, Aust.\ Acad.\ of Science, (1964); J.\,N. Churchyard,
\textit{Aqua}, vol.\,11, no.\,12, (1960); \textit{CSIR Bull.}
no.\,137.}
...
Soldier Settlement in 1925.\fn{E.~Mead (1914), \textit{op.\ cit.};
Vic.\ PP no.\,32 of 1925;
\cite{scholes1989}}

The SRWSC relied entirely on earthen
\index{technology!channel}channels for distribution of water to
irrigators, thus efficiency was lost as a result of seepage
\index{seepage} which in some places contributed later to waterlogging
\index{drainage!waterlogging} with harmful effects for irrigated
...
1920.\fn{I.~Meacham, \textit{Aqua}, (1961), p.\,184.}

By 1920 the Victorian area under irrigation, including Mildura,
\index{Mildura, Vic.}  increased to about 370\,000 ac from 104\,000 in
1906--07.  Pastures \index{pasture}and \index{fodder}luc\-er\-ne
accounted for most of the irrigation by 1920, with
\index{vineyards}vines, \index{fruit}orchards and
\index{vegetables}vegetables covering less than a quarter of the
...
government intervention.\fn{\cite[pp.\,54--55]{mccoy1988}; Ann.\ Rept
SRWSC 1918.}
...
the Water Rights Act \index{legislation!NSW!Water Rights Act 1896}
vested water rights in the Crown and instituted a system of licences
for \index{technology!dam}dams and diversions from streams for
irrigation by individual landholders.  The immediate effect of the
legislation was to recognise a practice which had been in existence
for some time, often with considerable friction between water-users.
Two landholders who made early use of the provisions of the Act to
divert water for irrigation were Samuel McCaughey \index{McCaughey,
S.} in the Riverina, and Thomas Ellis on the Hunter River
\index{river!Hunter} in north of the State.  In the longer term,
however, the Act provided the basis for further intervention by the
state.\fn{\cite{evatt1938}; \cite[p.\,183]{lloyd1988}.}
...
extension of irrigation without a storage
\index{technology!reservoir}reservoir; he favoured the Barren Jack
site, southwest of Yass, as most appropriate for storage on the
Murrumbidgee.\fn{NSW Rept RCWater Conserv.\ 1885--87; NSW LA VP 1897,
vol.\,5 Rept On the Prospects of Irrigation in NSW by Col.\
F.\,J.~Home; \noibidem\cite[pp.\,178--80, 182--83]{lloyd1988}.}

The serious \index{drought}drought which culminated in 1902 led to a
renewal of interest in irrigation, expressed in several ways.  Passage
of the Water and Drainage Act 1902 \index{legislation!NSW!Water and
Drainage Act 1902} provided funds for waterworks, established the
...
lucerne and 250\,acres of sorghum.\fn{\cite[pp.\,124--25]{lloyd1988};
\cite[p.\,16]{evatt1938}; Vic.\ PP no.\,35 of 1902--03;
\cite{mccaughey1955}.}
...
\index{finance}financial backing from Victoria and
\index{Britain}England and probably also had the promise of support
from Samuel \index{McCaughey, S.}McCaughey.  His special interest in
...
L.\,A.\,B.~Wade, \index{Wade, L.\,A.\,B.} its engineer, explained that
a major distinction from Gibson's scheme was the consideration of
irrigation both north and south of the river.\fn{J.\,A.~Gibson,
\textit{Proc.\ Hay Historical Soc.}, (1962); NSW LA VP 1903 vol.\,1,
NSW VP 1906 vol.\,5. Standing Comm.\ Public Works, Murrumbidgee Rept
\& MoE, MoE p.\,96; \cite{mccaughey1955}; \cite{lloyd1988};
\cite[p.\,135 re McKinney as the real planner]{munro1974}.}
...
the delegates was the engineer \index{Monash, J.}John Monash
representing the \index{district!Lower Murrumbidgee}Lower Murrumbidgee
...
this time \index{Wade, L.\,A.\,B.}L.\,A.\,B.~Wade, the principal
engineer of water supply and sewerage in the public works department,
had visited \index{USA}USA to study irrigation and was preparing plans
for the Burrinjuck \index{technology!reservoir}reservoir
\index{reservoir!Burrinjuck} on the Murrumbidgee and the use of its
...
responsibility for building the storage \index{technology!dam}dam.
...
\index{flood}flooding of the Lower Murrumbidgee below Hay; he voiced
...
\index{technology!canal}canals diverging from Yanco: the Gunbar canal
\index{canal!Gunbar} to the north and the Hay canal \index{canal!Hay}
to the west.\fn{\cite[p.\,187]{lloyd1988}; R.\,T.~McKay, `The
Utilisation of the Murrumbidgee Waters', \textit{Agr.\ Gaz.\ NSW},
vol.\,18, (1907), p.\,103; NSW PP VP Session 1906, Parl.\ Standing
Comm.\ Public Works, Rept \& MoE.}
...
the Burrinjuck \index{technology!dam}dam and the necessary works for
irrigation: the Barren Jack Dam and Murrumbidgee Canals Construction
Act 1906. \index{legislation!NSW!Barren Jack Dam and Murrumbidgee
Canals Const.\ Act 1906} The Public Works Department was to be the
...
reached a height of 70\,feet.\fn{W.\,H.~Williamson, `A Century of
Scientific Progress', \textit{Royal Soc.\ NSW}, ch.\,2, (1968),
p.\,63.}

In 1910 the Murrumbidgee Resumption Act
\index{legislation!NSW!Murrumbidgee Resumption Act 1910} and the
Murrumbidgee Irrigation Act \index{legislation!NSW!Murrumbidgee
Irrig.\ Act 1910} authorised the resumption of 1\,668\,000\,acres of
...
\index{American}American architect Walter Burley Griffin \index{Burley
Griffin, W.} were established in 1914: Leeton \index{Leeton, NSW} in
the Yanco area named for C.\,A.~Lee, \index{Lee, C.A.} the Minister
for Public Works first associated with the Murrumbidgee Irrigation
Area and Griffith \index{Griffith, NSW} in the Mirrool area for
\index{Griffith, A.}A.~Griffith, the second
Minister.\fn{\cite[p.\,114]{jeffcoat1988}.}
...
expected to be used for production of \index{fodder}lucerne and
...
\index{drainage}better-drained and more porous soils of land regarded
...
included the distinctive \index{Welsh}Welsh settlers from Patagonia
...
\index{Italians}Italian, though originally from Switzerland, was
allotted a farm in 1914 and two \index{Spanish}Spaniards obtained
farms in 1916.  A few Italians came to work as labourers before 1920
and several irrigation blocks were allotted to
\index{American}American migrants.  The well-known Australian writer
Henry Lawson \index{Lawson, H.}  spent a year in the Yanco area.
Between July 1912 and April 1914, 622 farms covering 24\,000\,acres
were allotted on perpetual lease.  At \index{Leeton, NSW}Leeton a
butter factory was opened in 1913, followed by a cannery in 1914.
Besides \index{dairy}dairying on the larger holdings and
\index{fruit}fruit grown on horticultural blocks, pigs and fat lambs
were raised and production was also diversified by growing
\index{tobacco}tobacco and broom millet.\fn{\cite{kelly1988};
\cite[pt.\,1]{langfordsmith1966}; \cite[ch.\,14]{lloyd1988}.}

Irrigators in the MIA were required to pay water rates sufficient `to
meet interest on the cost and upkeep of the storage
\index{technology!dam}dam and all main
\index{technology!channel}channels for conveyance of water to the main
...
year.'\fn{L.\,A.\,B.~Wade \textit{BAAS Hdbk NSW} (1914),
pp.\,147--48.}
...
earlier by \index{McCaughey, S.}Samuel McCaughey and provided the
...
valuation of the land.\fn{\noibidem\cite[p.\,212]{lloyd1988}.}
...
to support production of \index{fodder}fodder crops and
\index{fruit}fruit.  Initially it was expected that the basic supply
...
\index{drainage!waterlogging} occurred and was the beginning of a
long-held view among settlers that it was the consequence of
\index{seepage}seepage from the earthen
\index{technology!channel}channels.  However, this experience followed
...
\index{technology!Dethridge meter} were made available in 1911 soon
after their invention in Victoria they were apparently not used before
1920.\fn{L.\,A.\,B.~Wade, \textit{BAAS Hdbk NSW}, (1914), p.\,147;
Information by H.\,N.~England in Appendix~A of 1945 CSIR report by
J.\,A.~Prescott and others on waterlogging in Yanco no.\,1 Irrigation
Area; K.~Murley, `The Dethridge Meter', SRWSC, (1967).}
...
enquiries.\fn{\cite[p.\,215]{lloyd1988};
\cite[p.\,71]{davidson1969}.}
...
\index{legislation!NSW!Wentworth Irrig.\ Act 1890} of 1890 and in 1912
it came under the control of the Water Conservation and Irrigation
Commission (WCIC). \index{Water Conserv.\ and Irrig.\ Commission
(WCIC), NSW} Its location is on low-level alluvial land between
Tuckers Creek \index{creek!Tuckers} and the Murray River. Much of the
...
\index{technology!pump}pumping from the
\index{river!Murray}Murray River.  Irrigation was then used mainly for
\index{fruit}fruit growing.\fn{\textit{CSIR Bull}.\ 107, (1937).}
...
settlers in 1916. Water was \index{technology!pump}pumped
from the \index{river!Murrumbidgee}Murrumbidgee River to give each
settler a right to 24 inches of water annually for each acre incurring
the water rate.  Dairying was the main occupation in 1916.\fn{Ann.\
Rept to June 1916 of WCIC, NSW.}
...
were in force by 1918 for diversions from streams.  The
\index{river!Murray}Murray River was the major supplier for the
private diverters, whose pumps in 1919--20 were estimated as
delivering up to 40\,000\,acre-feet in New South Wales.  Although
details of irrigation by private licensees are not shown in annual
reports of the WCIC, the areas irrigated in 1920 from all streams in
the State are reported elsewhere as totalling more than
50\,000\,acres, mostly supplied by the Murray, Murrumbidgee,
\index{river!Lachlan}Lachlan, \index{river!Hunter}Hunter, and
\index{river!Namoi}Namoi.  Accordingly, irrigation by private
...
1920; \cite[pp.\,71--81]{hallows1996}}
...
the Crown Lands Act 1897 \index{legislation!SA!Crown Lands Act 1897}
...
reclamation included the protection of a large swamp from
\index{flood}flooding by an embankment erected in 1881 by Sir William
Jervois \index{Jervois, W.} who acquired the Wellington pastoral
property during his term as Governor of the colony.  Irrigation was
being undertaken later on swamps after their reclamation by a few
landowners including J.~Cowan \index{Cowan, J.}  at Glen Lossie
(700\,acres) and H.\,W.~Morphett \index{Morphett, H.W.}  at Woods
Point (650\,acres), who along with many others gave evidence in 1902
to the Interstate Royal Commission on the River Murray aboard a
\index{technology!paddle-steamer}paddle steamer travelling along the
river.\fn{Vic.\ PP no.\,35 of 1902--03, vol.\,3.}
...
subdivision of several swamps near \index{Murray Bridge, SA}Murray
Bridge and the Department of Agriculture established an experimental
farm on the Mobilong swamp \index{swamp!Mobilong} in 1906 with Samuel
McIntosh \index{McIntosh, S.} as manager.  He later became government
...
protection against \index{flood}floods, so to cope with those of the
magnitude known in 1870, a height of almost eight feet was necessary
at Murray Bridge \index{Murray Bridge, SA} instead of the lower
...
be used to assist \index{drainage}drainage during periods of low river
...
opened \index{technology!sluice gate}sluice gates took days
to remove by pumping.  The main use of the swamps reclaimed for closer
settlement was \index{dairy}dairying.  Over the period 1904 to 1909
...
50\,acres.\fn{D.\,J.~Gordon, \textit{Hndbk of South Australia},
(1908); SA PP 29 of 1910, S.~Murray's report; J.\,K.~Taylor \&
H.\,G.~Poole, `Report on the Soils of the Bed of Lake Albert, SA',
\textit{J.\,CSIR}, vol.\,5, (1932), pp.\,129--130; S.~McIntosh,
`Irrigation and Reclamation', \textit{J.\,Agric.\ SA}, vol.\,15, March
(1912), p.\,812; A.\,J.~Perkins, \textit{J.\,Agric.\ SA}, vol.\,6,
(1903).}
...
\index{legislation!SA!Irrig.\ and Reclamation Lands Act 1908} enabled
the government to begin extension of irrigation along the Murray
upstream from Morgan.  \index{Morgan, SA} The legislation provided for
...
\index{irrigation!area!Waikerie} was thus established in 1909 with 66
holdings including 42 new ones on adjacent highland where water supply
\index{technology!channel}channels were made and supplied
by improved \index{technology!pump}pumping facilities.
Similarly the \index{irrigation!area!Kingston}King\-ston and
\index{irrigation!area!Moorook}Moorook Irrigation Areas provided for
irrigators once involved in village settlements at these localities;
and the \index{irrigation!area!Cadell}Cadell Irrigation Area (1916)
was established on land briefly occupied in the 1890s by the New Era
village settlement.\fn{B.\,J.~Menzies \& P.\,N.~Gray,
\textit{Irrigation and Settlement in the South Australian Riverland},
Tech.\ Paper Dept.\ Agric.\ SA no.\,7, (1983), p.\,191; SA PP 86 of
1913, p.\,4; \cite[p.\,56]{mack1994}; T.\,J.~Marshall \& N.\,J.~King,
\textit{CSIR Bull}.\ no.\,62, (1932).}
...
\index{fruit}fruit and \index{fruit}vegetables for the passing
traffic.  This segment of the \index{flood!plain}flood plain is backed
...
means of \index{technology!pump!centrifugal}centrifugal
pumps suitable for the low lifts involved.  The survey work led to a
start in 1909 on the construction of irrigation
\index{technology!channel}channels.  Pumping of water began
in 1910 when the Berri Irrigation Area was
proclaimed. \index{irrigation!area!Berri} The irrigated area spread
northwest and west from Berri \index{Berri, SA}township before and
...
\index{technology!pump}pumping equipment to be installed;
...
swales.\fn{\cite[p.\,4]{andison1953}; B.\,J.~Menzies \& P.\,N.~Gray,
(1983), \textit{op.\,cit.}, p.\,221.}
...
\index{Cobdogla, SA} pastoral run; it included extensive
\index{flood!plain}flood plains along the river backed by higher land
...
the land and making \index{technology!channel}channels.
...
supplied by a \index{technology!pump}pump lift of 30 to
40\,feet and earthen channels. The intention was to raise
\index{fodder}fodder crops and lucerne there as the basis for
\index{dairy}dairying.  The Cobdogla Irrigation Area
...
proclaimed.\fn{\cite[p.\,30]{woolmer1973}.}
...
Division in which the \index{Loveday, SA}Loveday township appeared
...
Division lying north of Lake Bonney.  \index{lake!Bonney} The good
returns available in the war period for \index{fruit!dried}dried fruit
...
objectives realised eventually at \index{Cobdogla, SA}Cobdogla.  The
...
Combustion
Pump. \index{technology!pump!internal-combustion-pow\-er\-ed}%
\index{technology!pump!Humphrey} An order was placed for two units but
...
\index{California}Californian irrigation colonies and provide a
pressurised piped supply for irrigation.  McIntosh learnt of the
recent invention in South Australia by W.\,R.~Hume \index{Hume, W.R.}
of \index{technology!pipe!concrete}concrete pipes manufactured by
...
\index{technology!pipe!Hume} were used by the government only in the
...
management. \index{legislation!SA!Irrig.\ and Reclamation Act of 1914}
The South Australian settlements on the Murray involved pumping from
the river but had no requirement for storage of water.\fn{SA
Irrigation and Reclamation Act no.\,1178 of 1914, Section 32.}
...
southern Flinders Ranges, \index{Flinders Ranges, SA} not far from the
township of Orroroo. \index{Orroroo, SA} In this district there was
interest in establishing a \index{technology!reservoir}reservoir in
the hills to hold water drained by Pekina Creek \index{creek!Pekina}
...
lucerne and \index{fodder}fodder crops were sown with the object of
helping the \index{dairy}dairying industry.  The Pekina scheme was
developed under the Water Conservation Act of 1886
\index{legislation!SA!Water Conserv.\ Act 1886} by the Public Works
Dept and was later leased to the municipal authority of the
district.\fn{S.~McIntosh, \textit{J.\,Agric.\ SA}, (1912);
\cite[p.\,56]{hammerton1986}.}
...
for this area involving construction of a \index{technology!dam}dam on
the Harvey River was proposed in 1912 when the government first
attempted to gain legislation known as the Rights in Water and
Irrigation Act \index{legislation!WA!Rights in Water and Irrig.\ Act
1914} 1914. Work started in 1915 to provide storage of 520 million
gallons for irrigation of up to 3000\,acres at the foot of the Darling
Range.  The Harvey Irrigation District
\index{irrigation!scheme!Harvey} which opened in 1916, after work by
the Public Works Department and the Water Supply Department, was the
sole entry by the Western Australian government for irrigation
development before 1920.  Hugh Oldham, \index{Oldham, H.} who had
worked earlier at Renmark and Mildura, was an engineer of the Water
Supply Department who referred to the Harvey scheme in 1913 and in
1918 to the Royal Commission on Agricultural Industries of the
South-west.\fn{WA VP 1917--18 Paper 15, 2nd Prog.\ Rept RC~Agric.\
Industries; WA PD 1912 vol.\,43, p.\,1853, 1913 vol.\,449; H.~Oldham
(1913), WA VP 1917--18, vol.\,2, Paper 15, 2nd Prog.\ Rept RC~Agric.\
Industries.}
...
Ayr. \index{Ayr, Qld} Efforts to introduce irrigation to the
\index{district!Bundaberg}Bundaberg \index{Bundaberg, Qld} district
began in 1889 when John Cran \index{Cran, J.} of the Millaquin
refinery negotiated with the Chaffey Brothers for irrigation of land
at Woongarra. That scheme was abandoned but success attended other
...
irrigation in 1903, with water pumped from the Burnett River,
...
an unsuccessful proposal to pump water from the
\index{river!Elliott}Elliott River to 3000\,acres.\fn{\textit{Brisbane
Evening Observer}, 6 Apr.\ 1889; H.\,E.\,A.~Eklund, \textit{Qld
Agric.\ J.}, (1923).}
...
of water resources.\fn{Qld JP 1910 vol.\,3, Rept on Water Resources of
...
government before 1920.\fn{\textit{Qld Agr.\ J}., (1924), Irrigation
Statistics, pp.\,289--308.}
...
River. \index{river!Clyde} Then several outbreaks of
\index{disease!typhoid}typhoid fever along that river during the early
...
valley and those in the \index{district!Tunbridge}Tunbridge district
of the Midlands.\fn{\cite[pp.\,152--54]{masoncox1994}.}

The government then legislated to recast the Clyde Water Trust,
\index{trust!water!Clyde} by the Clyde Water Act of
\index{legislation!Tas.!Clyde Water Act 1898} 1898, and to form the
Midland Water Trust, under the Midland Water Act
\index{legislation!Tas.!Midland Water Act 1898} of 1898.  The latter
trust would control water supply, in excess of the Clyde Trust's
quota, for irrigation and other purposes in the Midlands.  When the
Midland Trust agreed in 1901 to supply water to a company for
generation of electricity to manufacture calcium carbide, the Minister
for Land and Works intervened and began negotiations with another
company for a hydro-electric \index{technology!hydro-electricity}
scheme based on use of the lake waters.  One consequence was further
legislation\,---\,the \index{legislation!Tas.!Lakes Sorell \& Crescent
Conserv.\ Act 1901} Lakes Sorell and Crescent Conservation Act
...
conservation works at the Lakes.\fn{\cite[p.\,151]{masoncox1994}.}
...
authority.\fn{Tas.\ PP no.\,46 of 1902, Rept by Rahbek.}
...
Lake.\fn{\cite[p.\,170]{masoncox1994}; Tas.\ PP nos.\,11 of 1916, 28
of 1917.}\index{trust!water!Clyde}
...
and the experience of widespread \index{drought}drought during 1902
...
taxed the resources of the government departments of \index{state
...
%40. NSW Rept R.C.Water Conserv.1885-87 \& NSW LA VP 1897,vol.5 
...
%47. NSW VP 1906 vol.5.Standing Comm.Public Works,  Murrumbidgee 
%      Rept \& MoE, MoE p.96. 
%48. Patricia McCaughey 1955 \& C.J.Lloyd 1988.
%49. NSW LA VP 1903 vol.1, \&  C.H.Munro, Australian Water 
...
%52. NSW PP VP Session 1906, Parl.Standing Comm Public Works,Rept. \&
%      MoE. 
