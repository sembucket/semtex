...
\label{ch:reflect}
\fancyhead[RE]{\sffamily \small Chapter \thechapter.\  Conclusion}
...
\index{technology!channel}channels, and expensive
...
irrigation, sometimes a personal \index{finance}financial stake, but
...
were forced to provide \index{finance}financial backing of one sort or
...
of irrigation as engineers in \index{India}India; two gained
acquaintance with irrigation in \index{America}America; four were
...
Irrigation Act of 1886 \index{legislation!Vic.!Irrig.\ Act 1886}
enabled those trusts to obtain government \index{finance}financial
...
proposed by the Chaffey Brothers \index{Chaffey Bros} for an
...
his visit to \index{USA}USA in 1885 and to \index{Ceylon}Ceylon and
\index{India}India in 1891.
...
the land boom and Elwood Mead \index{Mead, E.} who was consulted by
...
people from the \index{British}British Isles, the known exceptions
being Germans \index{Germans} in South Australia.  Then with the
arrival of Chinese \index{Chinese} there began widespread
...
Many \index{Europeans}Europeans and \index{Americans}Americans came to
...
\index{Martelli, A.} the \index{Italy}Italian architect and engineer
...
irrigation in Tasmania.  There was also James Bladier, \index{Bladier,
J.} the \index{France}French vigneron at Bendigo who was partner in a
scheme for irrigation of \index{vineyards}vines at Adelaide Vale in
1860.  A few Americans involved with production of
\index{tobacco}tobacco and \index{hops}hops in north-eastern Victoria
included Hiram Crawford, \index{Crawford, H.}  who irrigated hops on
his Everton farm on the Ovens River.  \index{river!Ovens} The
\index{American}American A.~Spawn \index{Spawn, A.} promoted
irrigation colonies near Horsham \index{Horsham, Vic.} in the 1880s.

In 1910 Elwood \index{Mead, E.}Mead of the Victorian State Rivers and
Water Supply Commission went to \index{Britain}Britain,
\index{Europe}Europe, and \index{America}America, seeking migrants to
take up irrigation in Victoria.  Subsequently some
\index{Americans}Americans visited the new irrigation settlements but
few remained there.  A major migration affecting irrigation was the
arrival of the \index{Welsh}Welsh party from Patagonia, where they had
experience of irrigation, as settlers at the Murrumbidgee Irrigation
Authority.

The last significant groups of \index{Europeans}European migrants
actually involved in irrigation before 1920 were the Spaniards
\index{Spanish} from Catalonia who engaged in
\index{gardening}market-gardening at Bendigo, Echuca and Cohuna, and
the Russians \index{Russians} who in 1913 began the Jewish colony
engaged in irrigated \index{fruit}fruit production near Shepparton.
...
the \index{Britain}British Isles with water-meadows and the use of
...
\index{Chinese}Chinese \index{technology!water-wheel}water-wheels to
...
the Californian pump, \index{technology!pump!Californian} a type of
belt-pump \index{technology!pump!belt} widely used by Australian
alluvial goldminers and by small-scale irrigators.  Specifically
\index{British}English and \index{Italian}Italian systems of
...
from British \index{India}India and western USA during and after the
1880s.
...
\index{technology!pipe!concrete}
...
\index{technology!Dethridge meter} meter for water
...
animals, in particular for \index{horses}horses: irrigated
\index{pasture}pastures then were the equivalent of an oil well today
as far as transport was concerned. Ultimately the main benefit of
irrigation was to livestock industries dependent on
\index{fodder}fodder crops and pastures. One outcome was greater
production of \index{dairy}dairy produce in southern Australia.

Access to markets, involving transport, was often the key to the use
of irrigation. Production of \index{fruit}fruit under irrigation at
Mildura \index{Mildura, Vic.} and Renmark \index{Renmark, SA}
...
\index{river!Murray} had to await better transportation in the
twentieth century.

Drought \index{drought}was a major motivation for the adoption of
irrigation by many agriculturalists. Water drawn from dependable
sources near the River Murray \index{river!Murray}was first used
extensively in aid of \index{wheat}wheat-growing in parts of Victoria
subject to \index{drought}drought. Irrigation of \index{sugar
cane}sugar cane became a significant aid to production in parts of
Queensland.
...
\index{sewage}sewage, artesian \index{technology!bore}bores, and river
...
\index{river!Murray}Murray River system.  Efforts to utilise
underground water were highly successful only for \index{sugar
cane}sugar cane in Queensland.

At first, supplies from the river system were obtained mainly by
pumping, together with occasional diversion of \index{flood}flood
...
no construction of \index{technology!reservoir}reservoirs on the main
...
to meet the costs of supplying irrigation water.  \index{finance}This
...
\index{technology!reservoir}reservoir, weir and distribution
\index{technology!channel}channel.  This arrangement continued beyond
1920.  The South Australian settlements on the
\index{river!Murray}River Murray did not require provision of
\index{technology!reservoir}reservoirs and their charges for water,
...
River system had incurred problems of \index{salinity}salinity and
\index{drainage!waterlogging}waterlogging in several areas of
...
network of \index{technology!channel}channels. The
environment of Australia was always a challenge. If
\index{seepage}seepage occurred from irrigation ditches, they should
