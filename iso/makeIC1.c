...
extern component_handle  cfield(ivector, complex_vector_field *);
extern void              tophat(ivector, complex_vector_field, int);
extern float             normalize(ivector, cvector, component_handle, 
...
main(int argc, char *argv[])
{
  ...
  /*-------------------------------------------------------------------------*/
  /* Normalize the velocities to get q^2 = 1.  Find out the largest velocity */
