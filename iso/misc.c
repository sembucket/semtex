...
void copyVF (CVF       tgt,
	     const CVF src)
/* ------------------------------------------------------------------------- *
 * Copy all components of Z.
 * ------------------------------------------------------------------------- */
{
  int i;
  
  for (i = 1; i <= 3; i++) copyF (tgt[i], src[i]);
}
 ...
 * ------------------------------------------------------------------------- */
{
  ...
  for (i = 1; i <= 3; i++) scaleF (U[i], alpha);
}
