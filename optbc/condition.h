...
class Toutflow : public Condition
// ===========================================================================
// Boundary condition class for Toutflow type BCs of form dc/dn + K(c - C) = 0.
// Toutflow BCs affect problem Helmholtz matrices, but only on the diagonal, 
// and element-boundary, terms.
// ===========================================================================
{
public:
