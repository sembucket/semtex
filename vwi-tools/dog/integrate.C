...
// 
// This version modified for VWI: base flow has only W as non-zero.
//
// NBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBNBN
//
///////////////////////////////////////////////////////////////////////////////
...
// ---------------------------------------------------------------------------
{
  ...
  for (j = 0; j < 2; j++) {
    (*U[NBASE] = *U[2]) . gradient (j);
    N[2] -> timesPlus (*u[j], *U[NBASE]);
  }
...
// ---------------------------------------------------------------------------
{
  ...
  for (i = 0; i < 2; i++) {
    j = 2;
    (*U[NBASE] = *U[2]) . gradient (i);
    if (Geometry::cylindrical()) U[NBASE] -> mulY();
    N[i] -> timesPlus (*u[2], *U[NBASE]);
  }
